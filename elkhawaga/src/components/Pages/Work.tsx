                ...
                <div className="flex justify-center gap-4 mb-12">
                    {filters.map((cat) => (
                        <button
                            ...
                            className={`px-6 py-2 rounded-full text-sm font-semibold transition-all duration-200 ${activeCategory === cat ? 'bg-[#BE1E2D] text-white' : 'bg-white text-black'
                                }`}
                        >
                            {cat}
                        </button>
                ...
                <div className="flex flex-col items-center gap-8">
                    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 max-w-7xl mx-auto'>
                        {image.map((img, index) => (
                            <div
                                key={index}
                                onClick={() => setSelectedImage({ src: img, alt: "Image description" })}
